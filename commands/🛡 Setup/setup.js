...
module.exports = {
    ...
    run: async (client, message, args) => {
        // code here
        message.guild.channels.create("NB MUSIC 24/7 - Requests", {
            type: 'category',
            ...
            message.guild.channels.create(`『📻『 NB 24/7`, {
                ...
                message.guild.channels.create(` NB MUSIC Request`, {
                    type: 'text', // text channel
                    rateLimitPerUser: 6, //set chat delay
                    topic: `To request a Track, simply Type the **SONG NAME** into the Channel or the **URL** and the Bot will play it! Make sure that you are in the **right** Voice Channel (『📻『 NB 24/7)!`,
                    parent: channel1.id,
                    permissionOverwrites: [{
                        id: message.guild.id,
                    ...
                    let pehla = new MessageEmbed()
                        ...
                        .setTitle("NB MUSIC 24/7 | Request | Guide")
                    ...
                    let dusra = new MessageEmbed()
                        ...
                        .setThumbnail(client.user.displayAvatarURL())
                        .setAuthor(message.author.username)
                        .setTitle("NB MUSIC 24/7 - Best Free Music Bot of 2021")
                        .setDescription(`Join a voice channel and enter a song name or url to play.\n[Invite NB MUSIC 24/7](https://discord.com/api/oauth2/authorize?client_id=849947252839022612&permissions=8&scope=bot) • [Join Server](https://discord.gg/TZuNztq) • [Subscribe Now](https://www.youtube.com/nbproduction433)`)
